...
/**
 * @title HoodGram core interfaces
 * @notice Shared types and interfaces for the HoodGram protocol.
 *
 * The economic model:
...
interface IActivation {
    /**
     * @notice Whether `user` has ever activated (or been granted) a HoodGram account.
