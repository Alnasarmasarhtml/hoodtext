...
import {ICheckpointToken} from "./interfaces/ITeleHood.sol";

/**
 * @title TeleHoodToken
 * @notice $THOOD — the TeleHood token. Fixed supply, no tax, no blacklist, no owner, no pause.
 *
 ...
 *      always.
 */
contract TeleHoodToken is ERC20, ERC20Permit, ICheckpointToken {
     ...
     */
    constructor(address treasury) ERC20("TeleHood", "THOOD") ERC20Permit("TeleHood") {
