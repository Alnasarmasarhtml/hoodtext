 ...
 *      the endpoints.
 */
contract TeleHoodTokenTest is Fixture {
    ...
    function test_Constructor_RevertsOnZeroTreasury() public {
        vm.expectRevert(TeleHoodToken.ZeroAddress.selector);
        new TeleHoodToken(address(0));
    }
    ...
    function test_FutureLookup_BalanceOfAt() public {
        vm.expectRevert(TeleHoodToken.FutureLookup.selector);
