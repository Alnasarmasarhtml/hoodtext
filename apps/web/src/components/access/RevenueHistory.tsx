    ...
    <Panel as="section" tone="raised" notch="tr" className={s.panel}>
      ...
      {history.isError ? (
        ...
        <EmptyState
          ...
          body="The first payment lands here the moment it clears. A $5 activation or a room's rent, paid in $GRAM, 50% banked for holders, 50% for the treasury, split at the instant it arrives."
        />
      ) : (
        <>
