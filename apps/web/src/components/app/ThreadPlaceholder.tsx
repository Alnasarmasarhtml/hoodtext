      ...
      <header className={s.head}>
        ...
        <p className={s.lede}>
          {hasThreads
            ...
            : 'Paste a @handle or wallet address into the rail — TeleHood reads their registered X25519 key from KeyRegistry, a free view call, and the thread opens with no transaction. Or open a room: $10/month, members free.'}
        </p>
      </header>
